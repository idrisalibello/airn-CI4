...
<div class="card">
  ...
  <?php if (!empty($flash)): ?><div class="card flash" style="margin-top:14px;"><?= esc((string)$flash) ?></div><?php endif; ?>
  <?php if (!empty($error)): ?><div class="card err" style="margin-top:14px;"><?= esc((string)$error) ?></div><?php endif; ?>
  ...
  <?php if (!empty($decision) && is_array($decision)): ?>
    <p><strong>Latest:</strong> <?= esc((string)$decision['decision']) ?> <span class="muted">at <?= esc((string)($decision['created_at'] ?? '-')) ?></span></p>
